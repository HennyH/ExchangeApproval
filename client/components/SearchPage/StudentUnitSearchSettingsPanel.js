...
import Styles from './StudentUnitSearchSettingsPanel.css';

class StudentUnitSearchSettingsPowerForm extends Form {
...
export default function StudentUnitSearchSettingsPanel() {

    const state = {};

    function oninit() {
        state.form = StudentUnitSearchSettingsPowerForm.new();
    }
