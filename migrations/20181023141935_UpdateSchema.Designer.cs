...
namespace ExchangeApproval.Migrations
{
    ...
    [Migration("20181023141935_UpdateSchema")]
            ...
            modelBuilder.Entity("ExchangeApproval.Data.UWAStaffLogon", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, PasswordHash = "eMY4QLz+XrN/Fcanvr6KrjRoGxDlvljeq04a/O94ZAw=", Role = "StudentOffice", Salt = new byte[] { 114, 152, 81, 149, 18, 46, 245, 81, 176, 144, 215, 248, 214, 135, 232, 201 }, Username = "admin" }
                    );
                });
